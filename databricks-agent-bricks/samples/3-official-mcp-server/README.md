...
> A detailed **[Step-by-step](./STEP_BY_STEP.md)** guide covers in details all the aspects of the Databricks App implementation. The following guide lets you deploy the MCP server in minutes using automated scripts.
